...
fb_intent = "https://www.facebook.com/sharer/sharer.php"
...
def on_page_markdown(markdown, **kwargs):
    ...
    <div style="text-align: center; margin: 2rem 0; padding: 1rem; border-top: 1px solid #e0e0e0;">
        ...
        <div style="display: flex; justify-content: center; gap: 1rem; flex-wrap: wrap;">
            <a href="{x_intent}?text={page_url}" target="_blank" rel="noopener" 
            ...
            <a href="{fb_intent}?u={page_url}" target="_blank" rel="noopener"
